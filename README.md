...
* Color-coded status badges (Active, Pending, Inactive)
...
```bash
git clone https://github.com/alishasaeeddev-bot/student-record-dashboard.git
```
...
* User roles
* Status badges with different colours
...
* Sort records by name or status
* Add pagination
